...
namespace Lexer
{
    internal class Program
    {
        static void Main()
        {
            string str_enum = "enum samyil { first = 1, second=2,third};";
            Console.WriteLine(lexText(str_enum));
        }
        ...
        static Token lexer(string strToLex)
        {
            ...
            switch (strToLex)
            {
                ...
                //case "": return new Token("", TokenType.TOKEN_NUMBER);
                default: break;
            }
        ...
        static string lexText(string text)
        {
